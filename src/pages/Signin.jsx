          ...
          <div className='max-w-[450px] h-[600px] mx-auto bg-black/60 rounded-lg'>
            <div className='max-w-[320px] mx-auto py-16'>
              ...
              <form onSubmit={handleFormSubmit} className='w-full flex flex-col py-4'>
                ...
                <p className='font-nsans-light text-xs text-gray-400'>This page is protected by Google reCAPTCHA to ensure you're not a bot. <span className='text-blue-700'>Learn more.</span></p>
